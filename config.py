...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='dress', help='path of the dataset')
...
parser.add_argument('--train_size', dest='train_size', type=int, default=8000, help='# images used to train')
